...
CAMBIO (v2.2): Imports desde agent.memory.entities. Integración con
MemoryService para load_session() al cambiar de sesión.
"""
...
from agent.memory.entities import ConversationTurn

from ..entities import SessionItem, ChatMessage, ToolCallItem
