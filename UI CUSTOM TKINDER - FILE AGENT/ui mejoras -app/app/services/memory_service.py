...
Responsabilidades:
  - Abstracción sobre SQLiteMemoryStore para facts, preferences, search
...
from agent.memory.store import SQLiteMemoryStore, Fact, MemorySearchResult
...
class MemoryService:
    ...
    async def extract_session_facts(
        ...
        # Heuristic 1: Successfully used tools
    ...
    def _extract_preferences(self, message: str) -> dict[str, str]:
        ...
        # Simple patterns (English + Spanish)
        if any(w in lower for w in ("prefiero", "me gusta", "prefer", "i like", "i want")):
    ...
    async def get_preferences(self) -> dict[str, str]:
        ...
        # SQLiteMemoryStore no tiene list_all_preferences, usamos raw
